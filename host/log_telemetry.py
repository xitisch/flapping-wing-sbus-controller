"""Headless commanded-channel and receiver-voltage recorder.
...
def parse_arguments():
    parser = argparse.ArgumentParser(
        description=(
            "Record commanded channels and receiver battery voltage to CSV."
        )
    )
...
def run(args):
    ...
    with open_transmitter_serial(args.port) as ser:
        ...
        try:
            ...
            print(f"\nSaved {logger.sample_count} telemetry samples to {logger.path}")
